...
public interface ConfigurationProvider {
     ...
     * configuration.
     */
    public static final String CONFIG_PROVIDERS_PROPERTY = "com.jjlharrison.config.providers";
    /**
     * System property to define URLs to overriding jollyday configuration
     * files.
     */
    public static final String CONFIG_URLS_PROPERTY = "com.jjlharrison.config.urls";
