 ...
 */
package com.jjlharrison.jollyday.configuration;

import java.util.Properties;
import java.util.logging.Logger;

import com.jjlharrison.jollyday.ManagerParameter;
import com.jjlharrison.jollyday.configuration.impl.DefaultConfigurationProvider;
import com.jjlharrison.jollyday.configuration.impl.URLConfigurationProvider;
...
public class ConfigurationProviderManager {
     ...
     * by the system property 'com.jjlharrison.config.provider'.
     *
     * @param properties
