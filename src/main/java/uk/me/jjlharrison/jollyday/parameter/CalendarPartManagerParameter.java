package uk.me.jjlharrison.jollyday.parameter;

import java.net.URL;
import java.util.Properties;

import uk.me.jjlharrison.jollyday.util.ResourceUtil;
...
public class CalendarPartManagerParameter extends BaseManagerParameter {
	...
	public String getManangerImplClassName() {
		String className = getProperty(ManagerParameter.MANAGER_IMPL_CLASS_PREFIX + "."
				+ calendarPart);
		if (className == null) {
