...
import uk.me.jjlharrison.config.HolidayType;
...
public class RelativeToEasterSundayParser extends AbstractHolidayParser
{
     ...
     * @param holidayType
     *            a {@link uk.me.jjlharrison.config.HolidayType} object.
     * @param holidays
    ...
    protected void addChrstianHoliday(LocalDate day, String propertiesKey, HolidayType holidayType,
        ...
        uk.me.jjlharrison.jollyday.HolidayType type = xmlUtil.getType(holidayType);
