 ...
 * @version $Id: $
 */
package uk.me.jjlharrison.jollyday.util;
...
import uk.me.jjlharrison.config.ObjectFactory;
import uk.me.jjlharrison.config.Weekday;
import uk.me.jjlharrison.jollyday.holidaytype.LocalizedHolidayType;
...
public class XMLUtil {
     ...
     */
    public static final String PACKAGE = "uk.me.jjlharrison.config";
     ...
     *
     * @param weekday
     *            a {@link uk.me.jjlharrison.config.Weekday} object.
     ...
     *
     * @param month
     *            a {@link uk.me.jjlharrison.config.Month} object.
     * @return DateTimeConstants value.
     */
     ...
     */
    public HolidayType getType(uk.me.jjlharrison.config.HolidayType type) {
        switch (type) {
