...
import uk.me.jjlharrison.jollyday.configuration.ConfigurationProvider;

/**
 * An {@link ConfigurationProvider} implementation which reads a list of URLs
 * provided by the system property 'uk.me.jjlharrison.config.urls' in order they are
...
public class URLConfigurationProvider implements ConfigurationProvider {
     ...
     * property 'uk.me.jjlharrison.config.urls'.
     */
